...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Ноя 17 2023 г., 10:25
...
(5, '2023_11_16_122958_create_order_models_table', 1),
(6, '2023_11_16_133008_create_price_models_table', 1);
...
INSERT INTO `order_models` (`id`, `name`, `address`) VALUES
(1, 'wdawd', 'wadwadawdwadwad'),
(2, 'цвфвфцвцфвцф', 'цфвцфвфцвцфвцфвцф');
...
(2, 'Rolex Submariner', 1000000, 15),
(3, 'Louis Vuitton', 350000, 25),
(4, 'Crystal Lalique', 200000, 10),
(5, 'Montblanc Meisterstück', 60000, 2),
(6, 'Baccarat', 15000, 0);
